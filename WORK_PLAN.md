...
- [ ] TASK-006 Mac demo app
  - DESK: companion window + wire sense/core/art
  - SENSE: counters + daily profile JSON under `src/sense/`
  - CORE: `settleDay()` already scaffolded — wire real profile
...
- [ ] Align SENSE profile field names ↔ `src/core/profile.ts`
...
- Pet art: use current character/ assets until 老大 updates
- Process: self-claim in role; LEAD assigns cross-module; push each small stage
